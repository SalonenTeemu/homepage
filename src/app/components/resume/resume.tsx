		...
		<>
			...
			<div className="flex h-full w-full flex-col justify-center text-center lg:flex-row">
				...
				<div className="flex w-full justify-center p-4 lg:w-1/2 lg:justify-start">
					<div className="ml-0 flex w-full flex-col md:w-5/6 lg:ml-4 lg:mr-8 lg:w-5/6 xl:ml-16 xl:mr-16 xl:w-4/5 2xl:w-3/4">
						...
						<p className="text-md 3xl:text-3xl pb-4 pt-8 lg:text-lg 2xl:text-xl">Core Technologies</p>
